...
<html>
    ...
    <body>
         <center>
             ...
             <table border="2"><tr><th>Name</th><th>Roll No</th><th>Attandance</th></tr>
         ...
         try
        {
            ...
            Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/student?useTimeZone=true&serverTimezone=UTC&autoReconnect=true&useSSL=false","root","root");
